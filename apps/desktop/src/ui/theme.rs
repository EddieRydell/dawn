...
pub const MODAL_Z_INDEX: i32 = DROPDOWN_MENU_Z_INDEX + 1;
pub const MODAL_BACKDROP_RED: u8 = 0;
pub const MODAL_BACKDROP_GREEN: u8 = 0;
pub const MODAL_BACKDROP_BLUE: u8 = 0;
pub const MODAL_BACKDROP_ALPHA: u8 = 130;
pub const MODAL_DEFAULT_WIDTH: f64 = 420.0;
pub const MODAL_DEFAULT_MAX_HEIGHT: f64 = 460.0;
