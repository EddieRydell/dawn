...
This is a Dawn project. Keep authored project files in `project.dawn`, `setups/`, `layouts/`, `fixtures/`, `patches/`, `curves/`, `effects/`, and `sequences/`.
...
Validate edits with Dawn workspace checks before handing work back.
