...
use crate::services::document_store::{DocumentStoreCommand, DocumentStoreCore, ViewMode};
...
pub use crate::editor_session::SessionBufferState;
pub use crate::workspace_session::CreatedRuntimeFile;
...
impl AppCoordinator {
    ...
    pub fn sync_file_opened(
        ...
        view_mode: crate::services::editor_state::EditorViewMode,
    ) -> Result<(), String> {
        self.state
    ...
    pub fn sync_active_view_mode(
        &mut self,
        mode: crate::services::editor_state::EditorViewMode,
    ) -> Result<(), String> {
