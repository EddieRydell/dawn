...
impl From<RuntimeStatus> for RuntimeStatusDto {
    fn from(status: RuntimeStatus) -> Self {
        match status {
            RuntimeStatus::NoProjectOpen => Self::NoProjectOpen,
            RuntimeStatus::Saved => Self::Saved,
            RuntimeStatus::Message { message } => Self::Message { message },
        }
    }
}
...
impl From<CoordinatorSnapshot> for AppSnapshotDto {
    fn from(snapshot: CoordinatorSnapshot) -> Self {
