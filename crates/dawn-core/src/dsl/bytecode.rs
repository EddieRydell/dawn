...
impl BytecodeProgram {
    ...
    pub fn sample_effect(
        ...
        scratch: &mut super::DslVmScratch,
    ) -> Result<crate::values::Color, super::RuntimeError> {
        super::vm::run_sample_program(self, params, context, scratch)
    }
    ...
    pub fn sample_operator(
        ...
        super::vm::run_operator_program(self, params, context, sampler, scratch)
    }
}
